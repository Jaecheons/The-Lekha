  ...
  const cards: UnoCardData[] = [
    {
      ...
      number: "1",
      photoUrl: Img5,
      caption: "Funny how you think you are fat but all I see is a pulchritudinous girl.",
      musicName: "Love Grows",
      musicUrl: Music1,
    },
    {
      color: "bg-blue-500",
      number: "2",
      photoUrl: Img2,
      caption: "Is it my fault for falling for this little devil.",
    ...
    },
    {
      ...
      number: "3",
      photoUrl: Img3,
      caption: "ISTG that fucking brown gaze will kill me one day",
    ...
    },
    {
      ...
      number: "4",
      photoUrl: Img4,
      caption: "Sheesh last thing I needed was to see this elegancy in traditional.",
      musicName: "O Rangrez",
      musicUrl: Music4,
    },
    ...
    >
      ...
      {flipped.every((isFlipped) => isFlipped) && (
        <div className="text-center transition-all duration-500">
          ...
          >
            Well, I have written something for you Lekha<ChevronRight className="ml-2" />
          </button>
        </div>
      )}
    </div>
